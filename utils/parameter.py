...
def parser_opt():
    ...
    args.checkpoint_path_tr = os.path.join(os.environ.get('checkpoint_path'),os.environ.get('model_ckpt_name_tr'))
    args.checkpoint_path_pr = os.path.join(os.environ.get('checkpoint_path'), os.environ.get('model_ckpt_name_pr'))
